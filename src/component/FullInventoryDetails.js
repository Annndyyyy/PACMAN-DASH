...
import Linechart from "../component/chartdata/Linechart";
...
const FullInventoryDetails = ({ onClose }) => {
  return (
      ...
      <div className="inventory-expanded-inner-wrap cm-l2-expanded-inner-wrap">
        <div className="l2-exp-inner-head-con clearfix" style={{ alignItems: 'flex-start' }}>
          <div className="left l2-exp-inner-head-left">
            <div className="large-title-text" style={{ fontWeight: 800, fontSize: '2.3rem', letterSpacing: '-1px' }}>INVENTORY</div>
        ...
        <div className="cm-l2-table-area">
          <Table name="Inventory" tableData={tableData} />
        </div>
      </div>
    </div>
  );
...
export default FullInventoryDetails; 